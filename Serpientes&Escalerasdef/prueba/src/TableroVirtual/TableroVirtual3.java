...
public class TableroVirtual3 extends Tablero implements ActionListener{
 ...
 // setLayout(new BorderLayout());
  ...
  JLabel background=new JLabel(new ImageIcon("C:\\Users\\carop\\Documents\\UCAB\\6TO-7MO SEMESTRE\\Redes\\PROYECTO SERPIENTES\\tablero3.jpg"));
  background.setBounds(0, -10, 500, 500);
  add(background);
