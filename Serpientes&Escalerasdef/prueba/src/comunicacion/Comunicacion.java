    ...
    public void seleccionartablero(byte[] envio) {
        ...
        switch (tablero) {
            ...
            case "00000010": //caso de tablero 2
                ...
                Tablero Mitablero2 = new TableroVirtual2();
                Mitablero2.turno("00000000");

                break;
            case "00000011": //caso de tablero 3
                Tablero Mitablero3 = new TableroVirtual3();

                break;
            case "00000100": //caso de tablero 4

                Tablero Mitablero4 = new TableroVirtual4();
                break;
            case "00000101": //caso de tablero 5 
                Tablero Mitablero5 = new TableroVirtual5();
                break;
            case "00000110": //caso de tablero 6 
                Tablero Mitablero6 = new TableroVirtual6();
                break;
        }
